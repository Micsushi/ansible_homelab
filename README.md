...
- `stage2` - core service secrets
  - generated by `bash scripts/generate-values.sh` and applied by `bash scripts/apply-generated-values.sh --stage 2`:
...
- `stage3` - access/security variables (if enabled)
  - generated by `bash scripts/generate-values.sh` and applied by `bash scripts/apply-generated-values.sh --stage 3`:
    - `jwt_secret`
